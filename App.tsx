...
export default function App() {
    ...
    <div className="bg-white min-h-screen text-slate-900 selection:bg-emerald-100">
      <nav className="fixed top-0 w-full z-50 px-8 py-6 flex items-center justify-between glass-effect">
        ...
        <div className="hidden md:flex items-center space-x-10 text-sm font-semibold text-slate-500">
          ...
          <a href="#support" onClick={(e) => { e.preventDefault(); setMode('platform'); setActiveView('support'); }} className="hover:text-emerald-600 transition-colors">Support Us</a>
        </div>
        <Button variant="dark" onClick={() => setMode('platform')}>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          <div className="lg:w-1/2 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button onClick={() => setMode('platform')} className="px-12 py-5 text-lg">Start Tracking Now</Button>
              <Button onClick={() => { setMode('platform'); setActiveView('support'); }} variant="outline" className="px-12 py-5 text-lg">Support Development</Button>
            </div>
          </div>
      ...
      <section className="py-20 px-8 bg-slate-900 text-white text-center">
         <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Button onClick={() => { setMode('platform'); setActiveView('support'); }} variant="accent" className="mx-auto">Fuel the Project <Gift size={18} /></Button>
         </div>
      </section>
    </div>
  );
  ...
  if (mode === 'website') return <LandingPage />;
